...
class ResPartner(models.Model):
    ...
    activity_code_id    = fields.Many2many('elo.activity.code' , string ="Code d'activité", index=True)
    forme_juridique_id  = fields.Many2one('elo.forme.juridique', string="Forme juridique")
