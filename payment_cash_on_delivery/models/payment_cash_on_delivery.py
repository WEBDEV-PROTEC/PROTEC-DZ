...
class AcquirerCOD(models.Model):
    ...
    provider = fields.Selection(selection_add=[('cash_on_delivery', 'COD')],  ondelete={'cash_on_delivery': 'set default'} )
...
class TxCOD(models.Model):
    ...
    def _cash_on_delivery_form_validate(self,  data):
        ...
        if current_order:
            ...
            current_order._send_order_confirmation_mail()
