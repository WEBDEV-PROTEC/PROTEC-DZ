...
# Part of Softhealer Technologies.
{
    ...
    "category": "Website",
    "summary": """Multiples Of  Quantity In Shop Set Product Multiples Quantity Increase Product Quantity Decrease Quantity By Customer multiple quantity multiples qty at shop multiples of  qty Bulk Order Quantities Multi-unit Purchases Product Quantitie Shop Quantity Multiples Odoo""",
 ...
 Set Product Multiples Quantity App, Increase Product Quantity Module, Decrease Quantity By Customer Odoo.""",
    ...
    'assets': {
        'web.assets_frontend': [
            'sh_shop_qty/static/src/js/shop.js',
        ],
    },
