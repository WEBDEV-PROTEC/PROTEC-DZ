...
import '@printnode_base_lite/components/status_menu_view/status_menu_view';
...
registerModel({
    ...
    recordMethods: {
        ...
        _prepareRateUsURL() {
            ...
            return `https://apps.odoo.com/apps/modules/${odooVersion}/printnode_base_lite/#ratings`;
        },
