...
class AccountMove(models.Model):
    ...
    payment_method_id = fields.Many2one('account.payment.method', string='Payment Method', domain=[('journal_id.type', '=', 'cash')], copy=False)
    ...
    def create_update_stamp_duty_move_line(self):
        if self.payment_method_id and self.move_type == 'out_invoice':
